<h2 class="text-center p-3 mb-8 text-xl" style="background-color:#3F3F3F ; color: #fff; border-radius: 8px;"> QUẢN LÝ ĐƠN HÀNG</h2>
...
<form action="" method="POST">
    ...
    <div class="row mt-4">
        ...
        <input onclick="return confirm('Bạn có chắc muốn xóa đơn hàng này không ?')" type="submit" value="Xóa các mục chọn" name="del_click" class=" py-1 px-4 " style="border-radius: 4px; border: 1px solid #3f3f3f; background-color: #fff;">
